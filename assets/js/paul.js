...
if(getCookie("decada") == 'anos70'){
    ...
    document.getElementById("Imagem").src = "paul1";
    ...
    document.getElementById("Imagem").src = "paul2";
    ...
    document.getElementById("Imagem").src = "paul5";
}