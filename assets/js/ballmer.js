...
if(getCookie("decada") == 'anos70'){
    ...
    document.getElementById("Imageni").src = "assets/imgs/ballmer1.jpg";
    ...
    document.getElementById("Imageni").src = "assets/imgs/ballmer2.jpeg";
    ...
    document.getElementById("Imageni").src = "assets/imgs/ballmer3.jpeg";
}else if(getCookie("decada") == 'anos00'){
    document.getElementById("cssdec").href = "assets/css/biografia00.css";
    document.getElementById("logomicrosoftbio").src = "assets/imgs/Microsoft_Logo_(1987).svg.png";
    document.getElementById("Imageni").src = "assets/imgs/ballmer4.jpg";
    ...
    document.getElementById("Imageni").src = "assets/imgs/ballmer5.jpeg";
}