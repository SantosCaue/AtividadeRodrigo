...
if(getCookie("decada") == 'anos70'){
    ...
    document.getElementById("Imagem").src = "gates1";
    ...
    document.getElementById("Imagem").src = "gates2";
    ...
    document.getElementById("Imagem").src = "gates5";
}